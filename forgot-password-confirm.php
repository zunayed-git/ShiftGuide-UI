                                                    ...
                                                    <div>
                                                        ...
                                                        <form class="mt-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control form-control-lg" type="password" name="email" placeholder="Enter your new password" />
                                                            </div>
                                                            
                                                            <div class="mb-3">
                                                                <label class="form-label">Confirm Password</label>
                                                                <input class="form-control form-control-lg" type="password" name="email" placeholder="Enter your confirm password" />
                                                            </div>

                                                            <div class="d-grid gap-2 mt-3">
                                                                <a href="./index.php" class="btn btn-lg btn-info">Confirm</a>
                                                            </div>
                                                            <div class="text-center mt-3">
                                                                Don't have any account yet? <a href="./index.php" class="text-info">Sign Up</a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </section>
